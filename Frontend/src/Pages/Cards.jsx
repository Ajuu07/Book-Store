...
const Cards = ({ _id, title, image, description, category, price }) => {
  return (
    <div className="mt-4 mb-3 p-3">
      <div className="card w-92 bg-base-100 shadow-xl hover:scale-100 duration-200 dark:bg-slate-900 dark:text-white dark:border">
